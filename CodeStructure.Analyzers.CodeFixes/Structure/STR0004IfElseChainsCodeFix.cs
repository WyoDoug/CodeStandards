...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Str0004IfElseChainsCodeFix))]
public sealed class Str0004IfElseChainsCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds => [DiagnosticIds.STR0004];
    ...
    public override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        if (ifStatement != null)
        {
            bool canConvert = TryBuildSwitchExpression(ifStatement, out var _);
            ...
            if (canConvert)
            {
                CodeAction action = CodeAction.Create("Convert to switch expression",
                                                      ...
                                                      nameof(Str0004IfElseChainsCodeFix)
                                                     );
