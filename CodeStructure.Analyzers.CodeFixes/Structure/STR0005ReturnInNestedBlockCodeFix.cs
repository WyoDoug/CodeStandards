// // STR0005ReturnInNestedBlockCodeFix.cs
...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Str0005ReturnInNestedBlockCodeFix))]
public sealed class Str0005ReturnInNestedBlockCodeFix : CodeFixProvider
{
    ...
    public override ImmutableArray<string> FixableDiagnosticIds => [DiagnosticIds.STR0005];
    ...
    public override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        if (methodDeclaration != null || localFunction != null)
        {
            CodeAction action = CodeAction.Create("Convert to single return",
                                                  ...
                                                  nameof(Str0005ReturnInNestedBlockCodeFix)
                                                 );
